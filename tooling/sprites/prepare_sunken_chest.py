"""
Prepare the sunken chest prop sprite from a source JPG.

Steps:
1) Remove white background by flood-filling near-white pixels connected to the image edge.
2) Crop to visible sprite bounds.
3) Resize to one tile wide (32 px) with aspect ratio locked using nearest-neighbor.
